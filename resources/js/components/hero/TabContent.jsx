...
const TabContent = ({ number, title, subtitle = null }) => {
  return (
    <div className="flex gap-4 w-full h-14 items-center px-6 text-white text-xs uppercase font-bold cursor-pointer group transition-all duration-300 hover:scale-x-105 ease-in-out">
      <span
        id="slide-number"
